...
const adminSysUsersTable = document.getElementById('admin-system-users-table');
...
window.viewChatHistoryAdmin = (sessionId) => {
    ...
    document.body.style.overflow = 'hidden';
    setTimeout(() => { adminChatLog.scrollTop = adminChatLog.scrollHeight; }, 50);
};
...
document.querySelector('.nav-view-btn[data-view="admin"]')?.addEventListener('click', fetchAdminData);
